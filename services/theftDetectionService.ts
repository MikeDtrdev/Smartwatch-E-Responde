  ...
  private async triggerTheftSOS(
    ...
    try {
      ...
      const theftReportData = {
        ...
        reporterUid: this.userId ?? undefined,
        reporterName: 'Smartwatch Auto Report',
        anonymous: false,
        barangay: 'Unknown',
        multimedia: [],
        videos: [],
        status: 'pending',
        createdVia: 'smartwatch_auto_theft_detection',
        triggerSource: 'smartwatch_theft_detection',
        theftDetails: {
          distance: distance,
